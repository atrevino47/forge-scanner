...
| FIX-0004 | 2026-03-18 | AUDIT-001 BUG-3 | Backend+Frontend | [FIX-0004a](FIX-0004a.md), [FIX-0004b](FIX-0004b.md) | `capture-info/route.ts` + `SocialConfirmation.tsx` | SocialConfirmation sends empty email — always fails | partial (0004a: yes, 0004b: pending) |
